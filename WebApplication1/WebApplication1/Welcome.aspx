...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="readmore" runat="server" Text="READ MORE" Width="350px" BackColor="#009933" Font-Bold="True" Font-Names="Calibri" Font-Size="Larger" ForeColor="White" Height="50px" style="cursor:pointer; border-radius:25px; border:1px solid #009933" CssClass="readmore"/>
